...
class GetProjectTasksUseCase implements UseCase<PaginatedResponse<Task>, GetProjectTasksParams> {
  final TaskRepository repository;

  GetProjectTasksUseCase(this.repository);

  @override
  Future<dartz.Either<Failure, PaginatedResponse<Task>>> call(GetProjectTasksParams params) {
